      ...
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)] lg:items-end lg:gap-16">
        ...
        <div className="lg:pb-2">
          ...
          <div className="cta-action mt-8">
            ...
            <Link
              href="/contact/"
              className="group relative isolate inline-flex min-h-[56px] items-center gap-4 overflow-hidden rounded-full bg-bg py-2 pl-7 pr-2 text-sm font-semibold uppercase tracking-[0.08em] text-text shadow-[0_10px_28px_-14px_rgb(0_0_0/0.55)] ring-1 ring-transparent transition-[transform,box-shadow] duration-500 ease-out hover:shadow-[0_18px_40px_-16px_rgb(0_0_0/0.65)] hover:ring-bg/45 focus-visible:ring-bg/45 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-bg active:scale-[0.98]"
            >
              {/* label roll */}
